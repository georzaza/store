...
<div class="row">	
	<div class="col-sm-8" >
		...
		<br>
		<div>
			<a style="width: auto; margin-left:40%; " href="<?php echo e(route('recipes.create')); ?>" class="btn btn-success">Add New Recipe</a>  	
		</div>
		<br>
		<br>
			...
			<tbody id="recipes" class="text-center">
				<?php $__currentLoopData = $recipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr class="text-center">
						...
						<td>
							<a href="<?php echo e(route('recipes.edit',$recipe->recipe_id)); ?>" style="text-align: center;" class="btn btn-primary">Edit</a>
						</td>
						<td>
