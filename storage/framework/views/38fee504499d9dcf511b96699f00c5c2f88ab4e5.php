    ...
    <div class="col-sm-4 col-md-offset-4">
		...
		<form method="post" action="<?php echo e(route('products.update', $product->product_id)); ?>">
            ...
            <label for="product_name">Product Name:</label><br/>
            	...
            	<input type="date" class="form-control" name="exp_date" value="<?php echo e($product->exp_date); ?>"/>
        	</div>
        	<div class="form-group" >    
           		<label for="qty">Quantity</label><br/>
           		<input type="number" step="1" min=0 class="form-control" name="qty" value="<?php echo e($product->qty); ?>"/>
       		 </div>
       		 <div class="form-group" >    
           		 <label for="weight">Weight (in Kg / L) </label><br/>
    	    	<input type="number" step="0.001" min=0 class="form-control" name="weight" value="<?php echo e($product->weight); ?>"/>
        	</div>
	    	<div class="form-group" >    
           		 <label for="type">Details</label><br/>
            	<input type="text" size="40" maxlength="120" class="form-control" name="details" value="<?php echo e($product->details); ?>" />
        	</div>
			<br>
