...
<div class="row">
  	<div class="col-sm-12">
    	<h1 class="display-3">recipes</h1>
	  	<div>
    	<a style="margin: 19px;" href="<?php echo e(route('recipes.create')); ?>" class="btn btn-primary">New recipe</a>
    </div>   
    <table class="table">
      	<thead>
        	<tr>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bluebouris/Downloads/store/resources/views/recipes/index.blade.php ENDPATH**/ ?>