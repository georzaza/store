    ...
    <div class="col-sm-8 offset-sm-2">
		...
		<form method="post" action="<?php echo e(route('products.update', $product->product_id)); ?>">
			...
			<div class="form-group" style="text-align:center;">
    	    	...
    	    	<input type="text" class="form-control" name="type" value=<?php echo e($product->product_type); ?>>
			</div>
			<br>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bluebouris/Downloads/store/resources/views/products/edit.blade.php ENDPATH**/ ?>